    ...
    function renderpager(pagenumber, pagecount, buttonClickCallback) {
        ...
        for (var page = startPoint; page <= endPoint; page++) {
			...
			if(page == pagenumber){
				...
				currentButton.addClass('pgOther');
		...
		//------lzy------------------
         $pager.append('<li class="pgInput"><input type="text" id="jumpNum" name="jumpNum" class="jumpInput" value="'+pagenumber+'"/></li>');
          $Button = $('<li class="jump" id="jumpButton">跳转</li>');
          $Button.click(function(){
          		...
          		if(jumpNum > pagecount){
          			jumpNum = pagecount;
          		}
          		buttonClickCallback(jumpNum);
          });
          $pager.append($Button);
        //----end lzy--------------------
        return $pager;
