/**
 * @author migrsoft.com v1.0
 * @author migrsoft.com 2011-4-1
 */
(function($){
	$.fn.jTable = function(options){
		return this.each(function(){
			...
			var layoutV = $(this).attr("layoutV") || 0;
			...
			tbody.wrap("<div class='gridScroller'" + layoutStr + " style='width:" + ($tc.width()-layoutV) + "px;'><div class='gridTbody'><table style='width:" + (tlength - 20) + "px;'></table></div></div>");
